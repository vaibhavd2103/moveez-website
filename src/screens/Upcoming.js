...
function Upcoming() {
  ...
  return (
    <div className="container" style={{ backgroundColor: Colors.bg }}>
      ...
      <Category
        fetchUrl={`/movie/upcoming?api_key=${API_KEY}&page=1`}
        title="Action Movies"
      ...
      />
      <Category
        fetchUrl={`/movie/upcoming?api_key=${API_KEY}&page=2`}
        title="Cartoons"
      />
      <TVCategory fetchUrl={requests.tvScience} title="Sci-Fi Shows" />
      <Category
        fetchUrl={`/movie/upcoming?api_key=${API_KEY}&page=3`}
        title="Trending"
        categoryType="poster"
      />
      <TVCategory fetchUrl={requests.tvReality} title="Reality Shows" />
      <Category
        fetchUrl={`/movie/upcoming?api_key=${API_KEY}&page=4`}
        title="Adventure"
      />
      <TVCategory
      ...
      />
      <Category
        fetchUrl={`/movie/upcoming?api_key=${API_KEY}&page=5`}
        title="Horror Movies"
      />
    </div>
  );
